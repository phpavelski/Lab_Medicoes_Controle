...
scf(11)
plot2d(t,abs(U_seno1),1)
plot2d(t,abs(U_seno2),2)
plot2d(t4,abs(U_seno1pt4),3)
plot2d(t4,abs(U_seno2pt4),4)
xlabel('Tempo (s)')
ylabel('Amplitude')
...
scf(12)
plot2d(t,abs(U_mult1),1)
plot2d(t,abs(U_mult2),2)
plot2d(t4,abs(U_mult1pt4),3)
plot2d(t4,abs(U_mult2pt4),4)
xlabel('Tempo (s)')
ylabel('Amplitude')
legend(['4,01Hz - Parte 3';'4,16Hz - Parte 3';'4,01Hz - Parte 4';'4,16Hz - Parte 4'])
